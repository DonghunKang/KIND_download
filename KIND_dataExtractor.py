...
def makeReports():
    ...
    link_report = txt_to_list('links_10001_15000.txt')
...
#%% 엑셀파일로 기록
code = txt_to_list('codes_10001_15000.txt')    
workbook = xlsxwriter.Workbook('test_output_10001_15000.xlsx')
...
#%% test !!!!
link = 'http://kind.krx.co.kr/external/2012/07/23/000295/20120723000231/99602.htm'
